<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Actualiza tu cuenta e informacion de perfil.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="phone_number" value="{{ __('numero de contacto') }}" />
            <x-input id="phone_number" type="number" maxlength="20" class="mt-1 block w-full" wire:model.defer="state.phone_number" autocomplete="phone_number" />
